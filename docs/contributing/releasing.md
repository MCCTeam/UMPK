...
5. In GitHub branch protection or rulesets, require the PR workflow's build, test, format, dataset, generated-output, AOT, and NuGet package jobs before merging to `main`.
