...
/// <summary>Which world-border containment formula applies. Versions 1.14.4, 1.15.2, 1.17, 1.17.1, 1.19, 1.20.4, and 1.20.6 (protocols 498, 578, 755, 756, 759, 765, 766) all carry the <see cref="Legacy"/> shape; 1.21, 1.21.1, 1.21.2, 1.21.4, 1.21.5, 1.21.6, 1.21.7, 1.21.8, 1.21.9, 1.21.11, 26.1, 26.2 (protocols 767-776) all carry the <see cref="Modern"/> shape. The boundary is 1.21/protocol 767. The two formulas agree whenever the border's own bounds (<c>centerX/Z +/- size/2</c>) are integers and disagree ONLY on the min-X/min-Z edge otherwise - see <see cref="WorldBorderState.IsWithinBounds"/>'s remarks for the concrete case.</summary>
