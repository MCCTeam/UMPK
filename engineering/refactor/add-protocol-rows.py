...
TABLES: list[tuple[str, str, bool, str]] = [
    ("tests/Umpk.Protocol.Java.Tests/Registration/AliasCodecBindingTests.cs",
     "private static readonly int[] All =", True, ""),
    ("tests/Umpk.Protocol.Java.Tests/Login/ConnectionObligationBindingTests.cs",
     "private static readonly int[] All =", True, ""),
    ("tests/Umpk.Protocol.Java.Tests/Login/LoginCodecBindingTests.cs",
     "private static readonly int[] All =", True, ""),
    ("tests/Umpk.Protocol.Java.Tests/Registration/MisboundCodecFramingTests.cs",
     "private static readonly int[] AllProtocols =", True, ""),
    ("tests/Umpk.Protocol.Java.Tests/World/RespawnCodecBoundaryTests.cs",
     "public static readonly int[] AllProtocols =", True, ""),
    ("tests/Umpk.Protocol.Java.Tests/Item/UseItemFramingTests.cs",
    ...
    ("tests/Umpk.Client.Tests/RespawnSendTests.cs",
     "private static readonly int[] All =", True, ""),
    ("tests/Umpk.Client.Tests/SlabRestCompatibilityTests.cs",
     "private static readonly int[] All =", True, ""),
