...
/// <item>768-774: center, optional knockback, one particle, a sound holder.</item>
/// <item>775-776: the 768 body with radius and block count inserted and a weighted block-particle list.</item>
/// </list>
...
/// <param name="Radius">The explosion radius (775+).</param>
/// <param name="BlockCount">The destroyed-block count (775+).</param>
/// <param name="BlockParticles">The weighted block-particle list (775+).</param>
...
/// <summary>One weighted block-particle entry of the 26.2 explosion (particle plus scaling/speed and a weight).</summary>
